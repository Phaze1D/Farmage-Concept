...
module.exports.insert = new ValidatedMethod
  ...
  validate: ({provider_doc}) ->
    ProviderModule.Providers.simpleSchema().clean(provider_doc)
...
module.exports.update = new ValidatedMethod
  ...
  validate: ({organization_id, provider_id, provider_doc}) ->
    ProviderModule.Providers.simpleSchema().clean({$set: provider_doc}, {isModifier: true, removeEmptyStrings: false})
